...
Create_your_Amazon_account = driver.find_element(By.XPATH, "//a[@id='createAccountSubmit']").text
...
assert text_to_verify in sign_in_text
...
driver.maximize_window()
product = 'coffee'
driver.find_element(By.XPATH, "//input[@id='search']").send_keys(product )
